...
class RequiresContextResult(
    BaseContainer,
    SupportsKind3[u'RequiresContextResult', _ValueType, _ErrorType, _EnvType],
    ...
    def __init__(
        ...
        """
        super(RequiresContextResult, self).__init__(inner_value)
...
RequiresContextResult = final(RequiresContextResult)
